...
Schema-version changes must be explicit. Incompatible changes require a new schema version and migration/compatibility policy rather than silent reinterpretation.
